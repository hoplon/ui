...
(def default-button-up    {:color 0xffffff :s-color 0xcccccc :font-color 0x333})
(def default-button-down  {:color 0xd4d4d4 :s-color 0x8c8c8c :font-color 0x333})
(def primary-button-up    {:color 0x337ab7 :s-color 0x2e6da4 :font-color 0xfff})
(def primary-button-down  {:color 0x286090 :s-color 0x204d74 :font-color 0xfff})
(def success-button-up    {:color 0x5cb85c :s-color 0x4cae4c :font-color 0xfff})
(def success-button-down  {:color 0x449d44 :s-color 0x398439 :font-color 0xfff})
(def warning-button-up    {:color 0xf0ad4e :s-color 0xeea236 :font-color 0xfff})
(def warning-button-down  {:color 0xd58512 :s-color 0x985f0d :font-color 0xfff})
(def info-button-up       {:color 0x5bc0de :s-color 0x46b8da :font-color 0xfff})
(def info-button-down     {:color 0x31b0d5 :s-color 0x269abc :font-color 0xfff})
(def danger-button-up     {:color 0xd9534f :s-color 0xd43f3a :font-color 0xfff})

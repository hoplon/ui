...
(def formats       [:embedded-opentype :opentype :svg :truetype :woff :woff2])
...
(def stretches     [:normal :ultra-condensed :extra-condensed :condensed
...
(def weights       [:100 :200 :300 :400 :500 :600 :700 :800 :900])
...
(def list-types  [:none :circle :decimal :decimal-leading-zero :disc :square
                  ...
                  :upper-roman :lower-latin :upper-latin :arabic-indic :armenian
                  :bengali :devanagari :georgian :gujarati :gurmukhi :khmer :lao
                  :malayalam :myanmar :oriya :telugu :tai])
...
(def formats?         (validate-cells format?         "formats"))

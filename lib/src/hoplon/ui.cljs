...
(def leaf (comp shadow round border pad size listable fontable color transform clickable))
...
(def ^:dynamic *mdattrs*
  {:markdown         {:gv 10 :ms :all}
   :header           {:sh (r 1 1)}
   :header-1         {:f 32 :fb :strong}
   :header-2         {:f 24 :fi :italic}
   :header-3         {:f 20}
   :header-4         {:f 16}
   :header-5         {:f 14}
   :header-6         {:f 13}
   ...
   :image            {:sh (r 1 1)}
   :line-break       {:sh (r 1 1)}
   :link             {:m :pointer :fu :underline :fc :blue}
   :italic           {:fi :italic}
   :strong           {:fb :strong}})

...
(def numb   (-> h/input    box destyle fieldable   line-field      node            parse-args))
(def numbs  (-> h/input    box destyle fieldable   lines-field     node            parse-args))
...
(def submit (-> h/input    box destyle             submit-field    node            parse-args))
